...
```
├── aidata.py              # Main analysis script
├── llm_clients.py         # Modular LLM client system
...
├── README.md             # This file
├── llm_sikh_bias_prompts.csv    # Input prompts
└── llm_sikh_bias_responses.csv  # Output responses
```
